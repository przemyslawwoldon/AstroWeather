...
public class MoonFragmentF extends Fragment {
    ...
    public MoonFragmentF() {
    }

    public static MoonFragmentF newInstance(String param1, String param2, String param3) {
        MoonFragmentF fragment = new MoonFragmentF();
